 ...
 */
package com.github.creativeworks.docker.config;

import static com.github.creativeworks.cxf.common.JAXRSServerFactoryBeanUtils.*;

import java.util.List;

import com.github.creativeworks.cxf.common.JAXRSServerFactoryBeanUtils;
import com.github.creativeworks.docker.service.impl.DockerRestfulServiceImpl;
...
public class CXFServiceConfiguration {
  ...
  public Server server(Bus bus) {
    ...
    /* 设置服务提供方 */
    server.setServiceBeans(JAXRSServerFactoryBeanUtils.serviceBeans(new DockerRestfulServiceImpl()));
